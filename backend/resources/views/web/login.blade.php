...
@section('content')
    <div class="container card my-5 col-11 col-lg-4">
        ...
        <form id='form' hx-post="{{ url('login') }}" hx-swap='outerHTML' hx-select='#form' novalidate class="pb-2">
            @csrf
            ...
            @if (App\Models\Settings::has('enable_register'))
                <div>
                    <a href="{{ url('register') }}" class="text-secondary d-flex my-3">Register</a>
                </div>
            @endif
